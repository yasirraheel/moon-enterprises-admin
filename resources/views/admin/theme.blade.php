...
<div class="content">
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">{{ __('admin.app_logo') }}</label>
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  @if($settings->app_logo)
                    <img src="{{url('/public/img', $settings->app_logo)}}" style="width:150px">
                  @else
                ...
                <div class="input-group mb-1">
                  <input name="app_logo" type="file" class="form-control custom-file rounded-pill">
                </div>
                <small class="d-block">{{ __('misc.recommended_size') }} 400x200 px (PNG, JPG)</small>
		          </div>
		        </div>
