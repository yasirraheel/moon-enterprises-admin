	...
	<div class="row">
      ...
      @include('errors.errors-forms')
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $category->date }}" name="date" type="date" class="form-control">
		          </div>
		        </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $category->time }}" name="time" type="time" class="form-control">
		          </div>
		        </div>
            ...
            <fieldset class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="form-check form-switch form-switch-md">
                 <input class="form-check-input" type="checkbox" name="mode" @if ($category->mode == 'on') checked="checked" @endif value="on" role="switch">
               </div>
              </div>
            </fieldset><!-- end row -->
