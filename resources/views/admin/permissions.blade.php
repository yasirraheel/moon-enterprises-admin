<div class="row mb-3">
	<div class="col-sm-10 offset-sm-2">
		<div class="form-check">
			<input class="form-check-input fullAccess" name="permissions[]" value="full_access" @if (isset($permissions) && in_array('full_access', $permissions)) checked="checked" @endif type="checkbox" id="fullAccess">
			<label class="form-check-label" for="fullAccess">
				<strong>{{ __('admin.full_access') }}</strong>
			</label>
		</div>
		<small class="d-block text-success">{{ __('admin.info_full_access') }}</small>
	</div>
</div>
